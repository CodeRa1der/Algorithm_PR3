...
# Функции (линейный поиск, фиксация времени)
...
if __name__ == '__main__':
    ...
    array_sizes = [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000,
                2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000]  # Параметры для массивов
    num_experiments = 5  # Кол-во экспериментов
    ...
    for size in array_sizes:
        ...
        # Вычисление среднего времени выполнения алгоритма
    ...
    # Выполнение линейной регрессии и расчет коэффициента корреляции для обоих случаев
